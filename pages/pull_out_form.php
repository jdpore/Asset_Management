...
if (isset($_POST['print_pull_out'])) {
    ...
    foreach ($pull_out_data_result as $pull_out_data_row) {
        $asset_sticker_numbers[] = $pull_out_data_row['asset_id'];
    }
    $user_accountable_data_query = "SELECT * FROM employee_data WHERE employee_number = '" . $pull_out_data_row['employee_number'] . "'";
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="container">
                                <div class="row invoice-info">
                                    ...
                                    <div class="col-sm-4 mx-auto invoice-col">
                                        <address>
                                            <strong>Pull Out Date: </strong>
                                            <?php echo date('F d, Y', strtotime($pull_out_data['date_pull_out'])) ?><br>
                                            <strong>Control Number: </strong>
                                            <?php echo $pull_out_data['control_number'] ?><br>
                                            <strong>Location: </strong>
                                            <?php echo $pull_out_data['location'] ?><br>
                                        </address>
                                    </div>
                                    <!-- /.col -->
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="underline" style="border:none;">
                                                        <div class="name-label">
                                                            <div contenteditable="" class="name-label">[Enter Name]
                                                            </div>
                                                        </div>
